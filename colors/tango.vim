...
" Default Colors
hi Normal       guifg=#eeeeec guibg=grey20 ctermfg=gray ctermbg=black
hi NonText      guifg=#555753 guibg=grey20 gui=none
hi NonText      ctermfg=darkgray
hi Cursor       guibg=#d3d7cf
hi lCursor      guibg=#d3d7cf

" Search
hi Search       guifg=#CAB22B guibg=#3465A4
hi Search       cterm=none ctermfg=darkyellow ctermbg=darkblue
hi IncSearch    guibg=#eeeeec guifg=#729fcf
hi IncSearch    cterm=none ctermfg=yellow ctermbg=darkcyan

" Window Elements
hi StatusLine   guifg=#eeeeec guibg=#4e9a06 gui=bold
hi StatusLine   ctermfg=lightgray ctermbg=darkgreen cterm=bold
...
hi Visual       guifg=#d3d7cf guibg=#3465A4
